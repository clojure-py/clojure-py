...
;;     `test-vecseq`, `test-primitive-subvector-reduce`, `test-vec-compare`,
;;     `test-vec-creation`. The compare-on-vector path is also not yet
;;     implemented (PersistentVector lacks Comparable).
