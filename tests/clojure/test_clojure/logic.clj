...
;;  Created 1/29/2009
;;
;; Port of clojure/test/clojure/test_clojure/logic.clj.
...
(deftest test-if
  ...
  (are [x] (= (if x :t :f) :t)
       ...
       ;; Adaptation: JVM uses (new java.util.Date); Python's nearest
       ;; analog is datetime.datetime.
       (py.datetime/datetime 2024 1 1)))
