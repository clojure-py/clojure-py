...
;; Adaptation: JVM atoms implement java.util.function.Supplier /
;; IntSupplier / LongSupplier / BooleanSupplier / DoubleSupplier so
;; they're directly usable from Java functional code. Python has no
;; such interfaces; the original test (atoms-are-suppliers) is
;; JVM-only and is skipped.
