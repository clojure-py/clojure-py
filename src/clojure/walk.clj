...
;;
;; Port of clojure/walk.clj. Pure Clojure — no adaptations needed.
;; All deps (IMapEntry / MapEntry / IRecord / into / empty / with-meta /
;; macroexpand) are already in clojure.core.
